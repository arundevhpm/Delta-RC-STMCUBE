...
/**
  ...
  * @param  pRFSleep Pointer on a ST25DVXXKC_EN_STATUS value corresponding to the RF Sleep status.
  * @return int32_t enum status.
  */
...
/**
  * @brief  Writes the I2C Slave mode.
  * @param  deviceCode Device Code to be set.
  * @param  E0 E0 to be set.
  * @return int32_t enum status.
  */
int32_t NFC07A1_NFCTAG_WriteI2CSlaveMode( uint32_t Instance, const ST25DVxxKC_SLAVE_MODE_E slaveMode )
{
  UNUSED(Instance);
...
/**
  * @brief  Reads the I2C Slave mode.
  * @param  deviceCode Pointer on a uint8_t used to return the Device Code.
  * @param  E0 Pointer on a uint8_t used to return the E0.
  * @return int32_t enum status.
  */
int32_t NFC07A1_NFCTAG_ReadI2CSlaveMode( uint32_t Instance, ST25DVxxKC_SLAVE_MODE_E *const slaveMode )
{
  UNUSED(Instance);
  return ST25DVxxKC_ReadI2CSlaveMode(&NfcTagObj, slaveMode);
}
