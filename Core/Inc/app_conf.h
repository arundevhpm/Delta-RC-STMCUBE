...
#define CFG_FAST_CONN_ADV_INTERVAL_MIN (0xA0)//(0x80) /**< 80ms */
#define CFG_FAST_CONN_ADV_INTERVAL_MAX (0xC0)//(0xa0) /**< 100ms */
 ...
 */
#define CFG_BLE_NUM_GATT_SERVICES 12 //8
 ...
 * This parameter is ignored by the CPU2 when CFG_BLE_OPTIONS has SHCI_C2_BLE_INIT_OPTIONS_LL_ONLY flag set
 */
#define CFG_BLE_PREPARE_WRITE_LIST_SIZE ( 0x3A ) //BLE_PREP_WRITE_X_ATT(CFG_BLE_MAX_ATT_MTU)
 ...
 */
#define CFG_BLE_MBLOCK_COUNT ( 0x79 ) //(BLE_MBLOCKS_CALC(CFG_BLE_PREPARE_WRITE_LIST_SIZE, CFG_BLE_MAX_ATT_MTU, CFG_BLE_NUM_LINK))
...
#else
#define CFG_BLE_LS_SOURCE 1//(SHCI_C2_BLE_INIT_CFG_BLE_LS_NOCALIB | SHCI_C2_BLE_INIT_CFG_BLE_LS_OTHER_DEV | SHCI_C2_BLE_INIT_CFG_BLE_LS_CLK_LSE)
#endif
 ...
 */
#define CFG_BLE_OPTIONS CFG_BLE_LL_ONLY//(SHCI_C2_BLE_INIT_OPTIONS_LL_HOST | SHCI_C2_BLE_INIT_OPTIONS_WITH_SVC_CHANGE_DESC | SHCI_C2_BLE_INIT_OPTIONS_DEVICE_NAME_RW | SHCI_C2_BLE_INIT_OPTIONS_NO_EXT_ADV | SHCI_C2_BLE_INIT_OPTIONS_NO_CS_ALGO2 | SHCI_C2_BLE_INIT_OPTIONS_FULL_GATTDB_NVM | SHCI_C2_BLE_INIT_OPTIONS_GATT_CACHING_NOTUSED | SHCI_C2_BLE_INIT_OPTIONS_POWER_CLASS_2_3)
 ...
 *  Take care to disable TX_LOW_POWER in project settings (C and assembler)
 */
