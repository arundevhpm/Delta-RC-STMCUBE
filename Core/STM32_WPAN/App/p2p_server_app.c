 ...
 */
static TX_THREAD thread_P2PSProcess;
TX_SEMAPHORE sem_P2PSProcessSignal;
...
/* USER CODE BEGIN PFP */
static void thread_P2PSProcess_entry(ULONG argument);
...
//          BSP_LED_On(LED_BLUE);
//        	PWM_Start(LED_Blue);
        	Ueventsgrp.EventFlag_bits.BuzzBeepEvent = 1;//Start event of buzzer
...
static void thread_P2PSProcess_entry(ULONG argument)
{
  ...
  for(;;)
  {
	  tx_semaphore_get(&sem_P2PSProcessSignal, TX_WAIT_FOREVER);
...
/* USER CODE BEGIN P2PS_APP_Init */
 ...
 // UTIL_SEQ_RegTask( 1<< CFG_TASK_SW1_BUTTON_PUSHED_ID, UTIL_SEQ_RFU, P2PS_Send_Notification );
	...
	tx_semaphore_create(&sem_P2PSProcessSignal, "sem_P2PSProcessSignal", 0);
	  tx_byte_allocate(p_byte_pool, (VOID**) &p_pointer, DEMO_STACK_SIZE_REDUCED, TX_NO_WAIT);
	  tx_thread_create(&thread_P2PSProcess,
	                   "thread_P2PSProcess",
	                   thread_P2PSProcess_entry,
	                   0,
	                   p_pointer,
